...
export default function FaultyTerminal({
  ...
  useEffect(() => {
    ...
    const handleMouseMoveLocal = (e: any) => handleMouseMove(e);
    if (mouseReact) ctn.addEventListener('mousemove', handleMouseMoveLocal);

    return () => {
      cancelAnimationFrame(rafRef.current);
      resizeObserver.disconnect();
      if (mouseReact) ctn.removeEventListener('mousemove', handleMouseMoveLocal);
